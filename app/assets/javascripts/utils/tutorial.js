Capstone.runFirstTutorial = function () {
  ...
  helper.html("Welcome to Dig-it! Over here is the leaderboard, with the hottest songs of the users with the most digs. Check out Bury Us Alive, posted by ravi_sss_123!");
